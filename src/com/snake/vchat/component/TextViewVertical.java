...
public class TextViewVertical extends View {
	public static final String TAG = TextViewVertical.class.getSimpleName();
    	...
    	if(drawable!=null){
    		...
    		try{
    			if(drawable instanceof NinePatchDrawable){
    				...
    				Bitmap b = Bitmap.createBitmap(((BitmapDrawable) drawable).getBitmap(),0,0,mTextWidth,mTextHeight);
